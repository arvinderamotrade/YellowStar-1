...
public class PanchDb extends SQLiteOpenHelper
{
    public static final String tableName = "PanchDb";
    static String DATABASE_NAME="PanchTable";
    public static final String KEY_ID = "Id";
    public static final String col1 = "DistrictId";
    public static final String col2 = "District";

    public PanchDb(Context _cntxt)
    {
    ...
    public List<Data> getAllData() {
        ...
        if (cursor.moveToFirst())
        {
            ...
            {
                Data dataD = new Data();
                dataD.setID(cursor.getString(1));
                dataD.setNAME(cursor.getString(2));
