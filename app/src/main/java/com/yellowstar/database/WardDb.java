...
public class WardDb extends SQLiteOpenHelper
{
    public static final String tableName = "WardDbDb";
    static String DATABASE_NAME="WardDbTable";
    public static final String KEY_ID = "Id";
    public static final String col1 = "DistrictId";
    public static final String col2 = "District";

    public WardDb(Context _cntxt)
    {
